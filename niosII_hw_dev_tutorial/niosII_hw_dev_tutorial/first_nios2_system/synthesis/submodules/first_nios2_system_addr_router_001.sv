...
(
    ...
    localparam PAD5 = log2ceil(64'h111038 - 64'h111030); 
    localparam PAD6 = log2ceil(64'h111040 - 64'h111038); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h111040;
    ...
    // ( 0x111038 .. 0x111040 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 21'h111038   ) begin
