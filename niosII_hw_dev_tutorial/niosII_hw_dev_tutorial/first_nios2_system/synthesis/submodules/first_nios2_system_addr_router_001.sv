...
(
    ...
    localparam PAD4 = log2ceil(64'h89030 - 64'h89020); 
    localparam PAD5 = log2ceil(64'h89038 - 64'h89030); 
    localparam PAD6 = log2ceil(64'h89040 - 64'h89038); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h89040;
    ...
    // ( 0x89020 .. 0x89030 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 20'h89020   ) begin
            src_channel = 7'b1000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x89030 .. 0x89038 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 20'h89030   ) begin
            src_channel = 7'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 6;
    end

    // ( 0x89038 .. 0x89040 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 20'h89038   ) begin
